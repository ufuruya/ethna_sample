...
require_once 'Myproject_Error.php';
require_once 'Myproject_ActionClass.php';
require_once 'Myproject_ActionForm.php';
require_once 'Myproject_ViewClass.php';

/**
 *  Myproject application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Myproject
 */
class Myproject_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Myproject_View_Index',
         *  ),
         */
    );
    ...
    var $class = array(
        ...
        'form'          => 'Myproject_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Myproject_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Myproject_UrlHandler',
    );
    ...
    var $plugin_search_appids = array(
         ...
         *  2. Myproject_Plugin_Foo_Bar
         *  3. Ethna_Plugin_Foo_Bar
         *
         *  'Common', 'Myproject', 'Ethna',
         */
        'Myproject', 'Ethna',
    );
